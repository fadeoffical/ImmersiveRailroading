...
public class ItemUnloaderAugment extends PushPullAugment {

    public static final @NotNull Identifier ID = new Identifier(ImmersiveRailroading.MOD_ID, "item_unloader");

    public ItemUnloaderAugment() {
    ...
    public void update(@NotNull TileRailBase rail) {
        ...
        Arrays.stream(Facing.values())
                ...
                .forEach(inventory -> inventory.transferAllFrom(stock.cargoItems));
    }
}
