...
public class FluidUnloaderAugment extends PushPullAugment {

    public static final @NotNull Identifier ID = new Identifier(ImmersiveRailroading.MOD_ID, "fluid_unloader");

    public FluidUnloaderAugment() {
    ...
    public void update(@NotNull TileRailBase rail) {
        ...
        Arrays.stream(Facing.values())
                ...
                .forEach(tank -> stock.tank.drain(tank, 100, false));
    }
}
