...
public final class Permissions {
    ...
    public static final Player.PermissionAction LOCOMOTIVE_CONTROL = Player.registerAction(
            "immersiverailroading.entity.locomotive_control",
            "Control of Locomotives",
            ConfigPermissions.Defaults.LOCOMOTIVE_CONTROL
    );
    public static final Player.PermissionAction BRAKE_CONTROL = Player.registerAction(
            "immersiverailroading.entity.brake_control",
            "Control of Independent Brakes",
            ConfigPermissions.Defaults.BRAKE_CONTROL
    );
    public static final Player.PermissionAction COUPLING_HOOK = Player.registerAction(
    ...
    public static void register() {
        // loads static classes and constructors
    }
