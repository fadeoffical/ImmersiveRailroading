...
public class TrackExchangerModel implements ItemRender.IItemModel {
    ...
    public static void render(ItemStack stack, World world, RenderState state) {
        ...
        RailInfo info = new RailInfo(
                new RailSettings(data.gauge, data.track, TrackType.STRAIGHT, 18, 0, 1, TrackPositionType.FIXED, TrackSmoothing.BOTH, TrackDirection.NONE, data.railBed, ItemStack.EMPTY, false, false),
