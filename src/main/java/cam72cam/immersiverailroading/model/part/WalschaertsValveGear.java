...
public final class WalschaertsValveGear extends StephensonValveGear {
    ...
    private WalschaertsValveGear(WheelSet wheels, ModelState state,
        ...
        state = state.push(builder -> builder.groupAnimator((stock, group) -> {
            ...
            Vec3d returnCrankRotPoint = this.reverse ?
            ...
            Vec3d wheelRotationOffset = VecUtil.fromWrongYaw(returnCrankRotPoint.x - this.crankWheel.x, wheelAngle);

            Vec3d returnCrankOriginOffset = this.crankWheel.add(wheelRotationOffset.x, wheelRotationOffset.z, 0);
            ...
            Vec3d returnCrankRotationOffset = VecUtil.fromWrongYaw(returnCrankLength, (float) returnCrankAngle + (this.reverse ? 90 : -90));
            ...
            Vec3d returnCrankRodRotPoint = this.reverse ?
            ...
            Vec3d returnCrankRodRotationOffset = VecUtil.fromWrongYaw(returnCrankRodLength, returnCrankRodRot + (this.reverse ? -90 : 90));
            ...
            float raidiusBarAngle = this.reverse ?
